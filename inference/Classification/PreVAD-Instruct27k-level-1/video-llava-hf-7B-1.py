...
output_file = build_output_path('inference', 'Classification', 'PreVAD-Instruct27k-level-1', 'videollava-1.txt')      
...
for item in test_data:
    ...
    print(f"进度：{jindu}, predict:{predicted_class}, real:{item['superclass_name']}")
